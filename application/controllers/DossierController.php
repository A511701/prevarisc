...
class DossierController extends Zend_Controller_Action
{
    ...
    //ETUDES
        ...
        "30" => array("DATEINSERT","OBJET","NUMCHRONO","DATEMAIRIE","DATESECRETARIAT","COMMISSION","DESCGEN","DESCEFF","DATECOMM","AVIS","DATESDIS","PREVENTIONNISTE","DEMANDEUR","INCOMPLET","HORSDELAI","AVIS_COMMISSION", "NUMDOCURBA"),
        //RVRMD diag sécu
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            if ($this->_getParam("AVIS_DOSSIER_COMMISSION") 
                    ...
                    && $service_dossier->isDossierDonnantAvis($idNature)) {
                ...
                $dbEtab = new Model_DbTable_Etablissement();
                $service_dossier->saveDossierDonnantAvis($idDossier, $listeEtab, $cache, $this->_getParam('repercuterAvis'));
