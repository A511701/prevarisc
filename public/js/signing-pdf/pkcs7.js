      ...
      if(signer.authenticatedAttributes.length === 0) {
        ...
        for(var ai = 0; ai < signer.authenticatedAttributes.length; ++ai) {
          ...
          if(attr.type === forge.pki.oids.messageDigest) {
            ...
            // MODIFIED !  attr.value = mds[signer.digestAlgorithm].digest();
            //console.log("MLength : " + attr.messageLength);
            //console.log("Value : " + attr.value.toHex());
...
function _attributeToAsn1(attr) {
  ...
  if(attr.type === forge.pki.oids.contentType) {
    ...
    //MODIFIED ! value = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.OCTETSTRING, false,
      //attr.value.bytes());
